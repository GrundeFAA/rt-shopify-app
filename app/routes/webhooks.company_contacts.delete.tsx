...
import { processCompanyContactsDeleteWebhook } from "../modules/webhooks/services/process-company-contacts-delete-webhook.service";
...
export const action = async ({ request }: ActionFunctionArgs) => {
  try {
    ...
    await processCompanyContactsDeleteWebhook({
      adminContext,
