...
import { processCompanyContactsCreateWebhook } from "../modules/webhooks/services/process-company-contacts-create-webhook.service";
...
export const action = async ({ request }: ActionFunctionArgs) => {
  try {
    ...
    await processCompanyContactsCreateWebhook({
      adminContext,
